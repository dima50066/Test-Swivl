      ...
      <g mask="url(#mask0_0_299)">
        <g id="edit icon">
          <g id="delete copy">
            ...
            <path
              id="Rectangle"
              d="M4 17C2.89543 17 2 16.1046 2 15V3C2 1.89543 2.89543 1 4 1H14C15.1046 1 16 1.89543 16 3V4"
              stroke="#3E4056"
              strokeWidth="2"
            />
            <rect
            ...
            <path
              ...
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5 9C5 8.44772 5.44772 8 6 8H10L8 10H6C5.44772 10 5 9.55228 5 9Z"
              fill="#3E4056"
            />
            <path
              id="Combined Shape"
